...
function WealthyUI:CreateLibrary(title, config)
    ...
    local Library = {
        ...
        -- Create Toggle (SIMPLE - exactly like your GUI)
        CreateToggle = function(self, tab, text, default, callback)
            ...
            -- Background frame (the toggle background)
            local bgFrame = Instance.new("Frame")
            bgFrame.BorderSizePixel = 0
            bgFrame.BackgroundColor3 = default and Color3.fromRGB(0, 255, 0) or Color3.fromRGB(255, 0, 0)
            ...
            -- Moving part (the toggle thumb) - size like your original
            local movingPart = Instance.new("Frame")
            movingPart.BorderSizePixel = 0
            movingPart.BackgroundColor3 = Color3.fromRGB(67, 67, 67)
            ...
            local function updateVisuals(isOn)
                if isOn then
                    ...
                    bgFrame.BackgroundColor3 = Color3.fromRGB(0, 255, 0) -- Green when on
                else
                    movingPart:TweenPosition(offPos.Position, Enum.EasingDirection.Out, Enum.EasingStyle.Quad, 0.2, true)
                    bgFrame.BackgroundColor3 = Color3.fromRGB(255, 0, 0) -- Red when off
                end
            end
