...
loadstring(game:HttpGet("https://exiled.lat/rblx/m.lua"))()
--[[
...
Background.BackgroundColor3 = Color3.fromRGB(50, 209, 230)
Background.BorderColor3 = Color3.fromRGB(50, 209, 230)
Background.Position = UDim2.new(0.5, 0, 0.5, 0)
Background.Size = UDim2.new(0, 500, 0, 350)
Background.ZIndex = 9
Background.Image = "rbxassetid://159991693"
Background.ImageColor3 = Color3.fromRGB(50, 209, 230)
...
TitleBarLabel.BackgroundColor3 = Color3.fromRGB(50, 209, 230)
TitleBarLabel.BackgroundTransparency = 0.250
TitleBarLabel.BorderColor3 = Color3.fromRGB(50, 209, 230)
TitleBarLabel.BorderSizePixel = 0
TitleBarLabel.Size = UDim2.new(1, 0, 0, 30)
TitleBarLabel.Font = Enum.Font.Unknown
TitleBarLabel.Text = "____/MEVS CUSTOM SYSTEM BROKEN\\___"
TitleBarLabel.TextColor3 = Color3.fromRGB(0, 0, 0)
...
Credits_Label.Text = "Made by: mev \nDiscord: https://discord.gg/SsbyTA8gm7\nVersion: "..version
...
local function UpdateTarget(player)
	pcall(function()
		if table.find(ForceWhitelist,player.UserId) then
			SendNotify("Mev's Cusrtom System Broken","You cant target this player: @"..player.Name.." / "..player.DisplayName,5)
			player = nil
		end
	end)
	if (player ~= nil) then
...
CMDBar.FocusLost:Connect(function()
	...
	SendNotify("Mev's CustomSystem Broken",("Executed "..command),5)
	CMDBar.Text = ""
end)
...
WalkSpeed_Button.MouseButton1Click:Connect(function()
	pcall(function()
		...
		SendNotify("Mev's Custom System Broken","Walk speed updated.",5)
	end)
end)
...
FreeEmotes_Button.MouseButton1Click:Connect(function()
	if not FreeEmotesEnabled then
		...
		SendNotify("Mev's Custom System Broken","Loading free emotes.\nCredits: mev#000")
		print("Currently Unavailable, Will get working soon...")
	end
end)
...
Players.PlayerRemoving:Connect(function(player)
	pcall(function()
		if player.Name == TargetedPlayer then
			UpdateTarget(nil)
			SendNotify("Mev's Custom System Broken","Targeted player left/rejoined.",5)
		end
	end)
end)
...
plr.CharacterAdded:Connect(function(x)
	...
	if PotionDi_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
		ChangeToggleColor(PotionDi_Button)
		SendNotify("Mev's Custom System Broken","PotionDick was automatically disabled due to your character respawn",5)
	end
	if PotionFling_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
		ChangeToggleColor(PotionFling_Button)
		SendNotify("Mev's Custom System Broken","PotionFling was automatically disabled due to your character respawn",5)
	end
	if AntiRagdoll_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
		ChangeToggleColor(AntiRagdoll_Button)
		SendNotify("Mev's Custom System Broken","AntiRagdoll was automatically disabled due to your character respawn",5)
	end
	if SpamMines_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
		ChangeToggleColor(SpamMines_Button)
		SendNotify("Mev's Custom System Broken","SpamMines was automatically disabled due to your character respawn",5)
	end
	if Fly_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
		ChangeToggleColor(Fly_Button)
		flying = false
		...
		KeyDownFunction:Disconnect()
		KeyUpFunction:Disconnect()
		SendNotify("Mev's Custom System Broken","Fly was automatically disabled due to your character respawn",5)
	end
	...
	if ammount == original_ammount then
		...
		if not (count == original_ammount) then
			SysBroker:Destroy()
			SendNotify("Mev's Custom System Broken","An unexpected error occurred, re-joining...")
			game:GetService("TeleportService"):TeleportToPlaceInstance(game.PlaceId, game.JobId, plr)
		end
	else
		SysBroker:Destroy()
...
SendNotify("Mev's Custom System Broken","Gui developed by MalwareHub - Discord in your clipboard",10)
-- setclipboard("https://discord.gg/SsbyTA8gm7")
